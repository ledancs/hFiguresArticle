...
Connected Rings have the nodes connected by ``line segments'' and in some cases ``additional nodes''  are positioned in the ``ring’s interior'' \cite{draper2009survey}.
