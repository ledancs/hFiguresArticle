...
% REF from the paper from BMC
% Talk about the cognitive side of this techinque.

\subsubsection*{Heuristic Questionnaire}

% REF here!
% http://www.nngroup.com/articles/ten-usability-heuristics/

The questionnaire used for the Heuristic Evaluation measures the following metrics:
\begin{enumerate}
\item Visibility of the System Status (Feedback)
\item Match between system and the real world (Speak the User's Language)
\item User control and freedom (Clearly Marked Exits)
\item Consistency and standards (Consistency)
\item Error prevention (Prevent Errors)
\item Recognition rather than recall (Minimize User Memory Load)
\item Flexibility and efficiency of use (Shortcuts)
\item Aesthetic and minimalist design (Simple and Natural Dialogue)
\item Help Users recognize, diagnose, and recover from errors (Good Error Messages)
...
\subsubsection*{Task-Based Observation}
...
\paragraph*{Computer System Usability Questionnaire} Explain and cite again.

\paragraph*{After Scenario Questionnaire} Explain and cite again.

\paragraph*{Usefulness, Satisfaction and Ease of Use Questionnaire} Explain and cite again.

\subsubsection*{Interviews}

Feedback, likes and deslikes, suggestions for further improvements.
