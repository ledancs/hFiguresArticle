...
% hFigures complex
\begin{figure}[h!]
  \caption{\csentence{A heterogeneous hFigures example.} An overview of a modeled person comprised of several measurements with two time snapshots showing its evolution over time.}
