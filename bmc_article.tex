...
TENK specifies the criteria for ethics approval in the ``Ethical principles of research in the humanities and social and behavioural sciences and proposals for ethical review''. The study we conducted was a usability evaluation using simulated data not belonging to a real person. The results of the usability tests were kept anonymous and the collected data does not include sensitive information from the participants. According to the ethical principles of TENK our study does not require ethics approval \cite{tenk2009}.
