...
The graphical representation of health data requires a holistic approach. A holistic overview of a patient usually is comprised of large amounts of measurements which in turn translates to large datasets. Data visualizations need to scale to accommodate large datasets. Radar Visualizations scale to large datasets due to their circular distribution of the space.
...
These are radar visualizations where the center is the starting point from which ``line segments'' originate \cite{draper2009survey}. According to this classification, polar plots are divided into \textbf{trees} and \textbf{stars}.
...
% hGraph is Ring and Pl

In the context of health data visualization, radar visualizations have a potential to  visualize large amount of datasets due to their clarity in the data representation.
