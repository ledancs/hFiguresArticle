...
An ethical committee approval was not necessary since this study was a usability testing process portraying data not belonging to any person. The results of the usability tests were kept anonymous and the collected data does not include sensitive information from the participants. The experimental procedures described in this paper complied with the principles of Helsinki Declaration of 1975, as revised in 2000. All subjects gave informed consent to participate and they had a right to withdraw from the study at any time. The informed consent also explained that their names and identities will be kept confidential, that the results will not be linked to their identities and that the sessions will be recorded using a Web camera and microphone for further study.
