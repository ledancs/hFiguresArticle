...
The experimental procedures described in this paper complied with the principles of Helsinki Declaration of 1975, as revised in 2000. All subjects gave informed consent to participate and they had a right to withdraw from the study at any time. The informed consent also explained that their names and identities will be kept confidential, that the results will not be linked to their identities, the sessions will be recorded using a Web camera and microphone for further study and that the clinical data visualized did not belong to a real person. An ethical committee approval was not required since this study was a usability testing process portraying simulated data not belonging to a real person. The results of the usability tests were kept anonymous and the collected data does not include sensitive information from the participants.
...
The results of the usability tests are in machine-readable format as comma separated values.
\begin{itemize}
\item \textbf{Data home page:} Data archived at \url{http://www.tut.fi/phi/?p=319}
\item \textbf{Data index page:} Resource at BioSharing Information Resources indexing process at \url{https://biosharing.org/biodbcore-000734}
\item \textbf{Format:} Machine-readable in comma separated values
\end{itemize}
